...
<?php include 'header.php'; ?>
    ...
    <section class="medical-records">
        <div class="container">
            ...
            <div class="section-footer">
                <a href="login.php" class="button secondary">See Sample Record</a>
    ...
    <section class="doctors">
        <div class="container">
            <div class="section-header">
                ...
                <a href="login.php" class="button secondary">View All Doctors <i class="fas fa-arrow-right"></i></a>
            </div>
                    ...
                    <div class="doctor-card">
                        <?php if (!empty($doctor['photo'])): ?>
                            ...
                            <div class="card-content">
                                ...
                                <p>Specializing in <?php echo htmlspecialchars($doctor['specialty'] ?? ''); ?> with over
            ...
            <div class="content-wrapper">
                <div class="text-content">
                    ...
                    <div class="button-group">
                        ...
                        <a href="admin_login.php" class="button secondary">Provider Login</a>
                    </div>
                </div>
                <div class="image-container position-relative">
