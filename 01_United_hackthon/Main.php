        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <!-- <li class="nav-item">
                    <a class="nav-link" href="sos.php">SOS Alerts</a>
                </li> -->
                    ...
                    <div class="doctor-card">
                        <?php if (!empty($doctor['photo'])): ?>
                            ...
                            <div class="card-content">
                                ...
                                <div class="button-group">
                                    <a href="appointments.php?doctor_id=<?= htmlspecialchars($doctor['id']) ?>"
        ...
        <div class="container">
            <div class="content-wrapper">
                ...
                <div class="text-content">
                    ...
                    <div class="button-group">
                        <a href="security-whitepaper.php" class="button primary">View Security Whitepaper</a>
